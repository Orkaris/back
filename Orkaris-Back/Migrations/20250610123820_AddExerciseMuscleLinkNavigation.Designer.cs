...
namespace Orkaris_Back.Migrations
{
    ...
    [Migration("20250610123820_AddExerciseMuscleLinkNavigation")]
    partial class AddExerciseMuscleLinkNavigation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Orkaris_Back.Models.EntityFramework.ExerciseMuscleLink", b =>
                {
                    b.Property<Guid>("ExerciseId")
                        .HasColumnType("uuid")
                        .HasColumnName("exr_id");
            ...
            modelBuilder.Entity("Orkaris_Back.Models.EntityFramework.ExerciseMuscleLink", b =>
                {
                    b.HasOne("Orkaris_Back.Models.EntityFramework.Exercise", "ExerciseExerciseMuscle")
                        .WithMany("ExerciseMuscleExercise")
                        .HasForeignKey("ExerciseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Orkaris_Back.Models.EntityFramework.Muscle", "MuscleExerciseMuscle")
                        .WithMany("ExerciseMuscleMuscle")
                        .HasForeignKey("MuscleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ExerciseExerciseMuscle");

                    b.Navigation("MuscleExerciseMuscle");
                });
            ...
            modelBuilder.Entity("Orkaris_Back.Models.EntityFramework.Exercise", b =>
                {
                    ...
                    b.Navigation("ExerciseMuscleExercise");
                });
            ...
            modelBuilder.Entity("Orkaris_Back.Models.EntityFramework.Muscle", b =>
                {
                    b.Navigation("ExerciseMuscleMuscle");
                });
