...
-- Muscles principaux (nom en français, version courte si possible)
INSERT INTO t_e_muscle_mus (mus_id, mus_name) VALUES
('b1a1c1d1-e1f1-41a1-91a1-11a1b1c1d1e1', 'Pectoraux'),         -- Grand pectoral
('b2a2c2d2-e2f2-42a2-92a2-22a2b2c2d2e2', 'Triceps'),            -- Triceps brachial
('b3a3c3d3-e3f3-43a3-93a3-33a3b3c3d3e3', 'Épaules'),            -- Deltoïde
('b4a4c4d4-e4f4-44a4-94a4-44a4b4c4d4e4', 'Dorsaux'),            -- Grand dorsal
('b5a5c5d5-e5f5-45a5-95a5-55a5b5c5d5e5', 'Biceps'),             -- Biceps brachial
('b6a6c6d6-e6f6-46a6-96a6-66a6b6c6d6e6', 'Quadriceps'),         -- Quadriceps
('b7a7c7d7-e7f7-47a7-97a7-77a7b7c7d7e7', 'Ischios'),            -- Ischio-jambiers
('b8a8c8d8-e8f8-48a8-98a8-88a8b8c8d8e8', 'Fessiers'),           -- Grand fessier
('b9a9c9d9-e9f9-49a9-99a9-99a9b9c9d9e9', 'Mollets'),            -- Gastrocnémien
('c0a0c0d0-f0f0-40a0-90a0-00a0b0c0d0e0', 'Abdos'),              -- Grand droit de l'abdomen
('c1b1c1d1-f1f1-41b1-91b1-11b1b1c1d1e1', 'Trapèzes'),           -- Trapèze
('c2b2c2d2-f2f2-42b2-92b2-22b2b2c2d2e2', 'Obliques'),           -- Obliques
('c3b3c3d3-f3f3-43b3-93b3-33b3b3c3d3e3', 'Avant-bras'),         -- Avant-bras
('c4b4c4d4-f4f4-44b4-94b4-44b4b4c4d4e4', 'Dentelé'),            -- Dentelé antérieur
('c5b5c5d5-f5f5-45b5-95b5-55b5b5c5d5e5', 'Lombaires');          -- Érecteurs du rachis

-- Liens exercices <-> muscles principaux (exemples, à compléter selon ta table d'exercices)
-- Bench Press : Pectoraux, Triceps, Épaules
INSERT INTO t_e_exercise_muscle_link (exr_id, mus_id) VALUES
('9e3a1a58-fb71-4d6e-a3b1-68d1aefc7e01', 'b1a1c1d1-e1f1-41a1-91a1-11a1b1c1d1e1'), -- Pectoraux
('9e3a1a58-fb71-4d6e-a3b1-68d1aefc7e01', 'b2a2c2d2-e2f2-42a2-92a2-22a2b2c2d2e2'), -- Triceps
('9e3a1a58-fb71-4d6e-a3b1-68d1aefc7e01', 'b3a3c3d3-e3f3-43a3-93a3-33a3b3c3d3e3'), -- Épaules

-- Deadlift : Ischios, Fessiers, Dorsaux, Lombaires, Avant-bras
('6a345e31-2ba9-41ef-a23e-15cd9819fa89', 'b7a7c7d7-e7f7-47a7-97a7-77a7b7c7d7e7'), -- Ischios
('6a345e31-2ba9-41ef-a23e-15cd9819fa89', 'b8a8c8d8-e8f8-48a8-98a8-88a8b8c8d8e8'), -- Fessiers
('6a345e31-2ba9-41ef-a23e-15cd9819fa89', 'b4a4c4d4-e4f4-44a4-94a4-44a4b4c4d4e4'), -- Dorsaux
('6a345e31-2ba9-41ef-a23e-15cd9819fa89', 'c5b5c5d5-f5f5-45b5-95b5-55b5b5c5d5e5'), -- Lombaires
('6a345e31-2ba9-41ef-a23e-15cd9819fa89', 'c3b3c3d3-f3f3-43b3-93b3-33b3b3c3d3e3'), -- Avant-bras

-- Squat : Quadriceps, Fessiers, Ischios, Mollets
('f89ea42b-56d2-4c36-8f4e-f76f8498f9df', 'b6a6c6d6-e6f6-46a6-96a6-66a6b6c6d6e6'), -- Quadriceps
('f89ea42b-56d2-4c36-8f4e-f76f8498f9df', 'b8a8c8d8-e8f8-48a8-98a8-88a8b8c8d8e8'), -- Fessiers
('f89ea42b-56d2-4c36-8f4e-f76f8498f9df', 'b7a7c7d7-e7f7-47a7-97a7-77a7b7c7d7e7'), -- Ischios
('f89ea42b-56d2-4c36-8f4e-f76f8498f9df', 'b9a9c9d9-e9f9-49a9-99a9-99a9b9c9d9e9'), -- Mollets

-- Pull-Up : Dorsaux, Biceps, Trapèzes, Avant-bras
('b1f78aa1-8f07-40db-bd07-e0b2689ec3b2', 'b4a4c4d4-e4f4-44a4-94a4-44a4b4c4d4e4'), -- Dorsaux
('b1f78aa1-8f07-40db-bd07-e0b2689ec3b2', 'b5a5c5d5-e5f5-45a5-95a5-55a5b5c5d5e5'), -- Biceps
('b1f78aa1-8f07-40db-bd07-e0b2689ec3b2', 'c1b1c1d1-f1f1-41b1-91b1-11b1b1c1d1e1'), -- Trapèzes
('b1f78aa1-8f07-40db-bd07-e0b2689ec3b2', 'c3b3c3d3-f3f3-43b3-93b3-33b3b3c3d3e3'), -- Avant-bras

-- Military Press : Épaules, Triceps, Trapèzes
('55667788-99aa-bbcc-ddee-ff0011223344', 'b3a3c3d3-e3f3-43a3-93a3-33a3b3c3d3e3'), -- Épaules
('55667788-99aa-bbcc-ddee-ff0011223344', 'b2a2c2d2-e2f2-42a2-92a2-22a2b2c2d2e2'), -- Triceps
('55667788-99aa-bbcc-ddee-ff0011223344', 'c1b1c1d1-f1f1-41b1-91b1-11b1b1c1d1e1'), -- Trapèzes

-- Curl Biceps : Biceps, Avant-bras
('1a2b3c4d-5e6f-7081-9201-aefaccddeeff', 'b5a5c5d5-e5f5-45a5-95a5-55a5b5c5d5e5'), -- Biceps
('1a2b3c4d-5e6f-7081-9201-aefaccddeeff', 'c3b3c3d3-f3f3-43b3-93b3-33b3b3c3d3e3'), -- Avant-bras

-- Crunch : Abdos, Obliques
('1100aabb-ccdd-eeff-9988-776655443322', 'c0a0c0d0-f0f0-40a0-90a0-00a0b0c0d0e0'), -- Abdos
('1100aabb-ccdd-eeff-9988-776655443322', 'c2b2c2d2-f2f2-42b2-92b2-22b2b2c2d2e2'); -- Obliques